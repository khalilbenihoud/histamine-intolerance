...
const rawFoods: Food[] = [
  ...
  { name: "Mozzarella", category: "Dairy & Eggs", histamine: 34, trigger: 28, tier: 2, note: "Young cheese, moderate." },
  ...
  { name: "Corn / polenta", category: "Grains & Legumes", histamine: 16, trigger: 16, tier: 1, note: "Generally fine." },
